...
namespace API.Data.Migrations
{
    ...
    [Migration("20240206075048_UpdateCandidatePartyRelation")]
    partial class UpdateCandidatePartyRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Entities.Candidate", b =>
                {
                    ...
                    b.HasOne("API.Entities.Party", "Party")
                        .WithOne("Candidate")
                        .HasForeignKey("API.Entities.Candidate", "PartyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("API.Entities.PartyVotes", b =>
                {
                    ...
                    b.HasOne("API.Entities.Party", "Party")
                        .WithOne("PartyVotes")
                        .HasForeignKey("API.Entities.PartyVotes", "PartyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
